...
Offset computeOffsetFromDirection(
  Rail currentRail,
  RailMoveDirection moveDirection,
) {
  final direction = switch (moveDirection) {
    RailMoveDirection.forward => currentRail.from,
    RailMoveDirection.backward => currentRail.to,
  };

  return switch (direction) {
    Direction.top => currentRail.cell.rect.topCenter,
    Direction.bottom => currentRail.cell.rect.bottomCenter,
    Direction.left => currentRail.cell.rect.centerLeft,
    Direction.right => currentRail.cell.rect.centerRight,
  };
}
